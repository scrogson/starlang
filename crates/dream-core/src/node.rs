//! Node identity types for distributed DREAM.
//!
...
/// A node identifier.
///
/// Each node in a DREAM cluster has a unique numeric ID. The local node
...
///
/// ```
/// use dream_core::node::{init_node, NodeName};
///
